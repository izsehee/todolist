...
public class TodoController {
    ...
    public TodoItem createTodo(@RequestHeader(value="authorization") String author, @RequestBody TodoItem todo){
        todo.setUser(author);
    ...
    public String updateTodo(@RequestHeader(value="authorization") String author, @PathVariable Integer id, @RequestBody TodoItem newTodo){
    ...
    public String updateTodoComp(@RequestHeader(value="authorization") String author, @PathVariable(value = "id") Integer id){
    ...
    public String updateTodoIncomp(@RequestHeader(value="authorization") String author, @PathVariable(value = "id") Integer id){
